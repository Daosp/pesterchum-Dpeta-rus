{"main":
 {"style": "background-repeat: no-repeat;",
  ...
  "menus": {"client": {"_name": " À»≈Õ“",
            ...
            "rclickchumlist": {"pester": "ƒŒ—“¿“‹",
                               ...
                               "viewlog": "œŒ—ÃŒ“–≈“‹ ÀŒ√»",
                               "notes": "»«Ã≈Õ»“‹ «¿Ã≈“ ”...",
                               "unblockchum": "–¿«¡ÀŒ »–Œ¬¿“‹  Œ–≈ÿ¿",
                               "removegroup": "”ƒ¿À»“‹ √–”œœ”",
                               "renamegroup": "œ≈–≈»Ã≈ÕŒ¬¿“‹ √–”œœ”",
                               "movechum": "œ≈–≈Ã≈—“»“‹ ¬",
                               "banuser": "«¿¡¿Õ»“‹",
                               "opuser": "œ–Œ¬≈–»“‹",
                               "voiceuser": "√ŒÀŒ—",
                               ...
                               "invitechum": "œ–»√À¿—»“‹  Œ–≈ÿ¿",
                               "memosetting": "Õ¿—“–Œ… » √–”œœ€",
                               "memonoquirk": "Œ“ Àﬁ◊»“‹ œ–¿¬»À¿",
                               "memohidden": "— –€“‹—ﬂ",
                               "memoinvite": "“ŒÀ‹ Œ œŒ œ–»√À¿ÿ≈Õ»ﬁ",
                               "memomute": "«¿“ Õ”“‹—ﬂ",
							   "beeponmessage": "«¬”  Œ —ŒŒ¡ÿ≈Õ»ﬂ’",
							   "flashonmessage": "Ã»√¿“‹ œ–» —ŒŒ¡Ÿ≈Õ»»",
							   "mutenotifications": "Œ“ Àﬁ◊»“‹ ŒœŒ¬≈Ÿ≈Õ»ﬂ"
                              }
           },
 ...
 {"style": "background-color: #fdb302;background-image:url($path/convobg.png);background-repeat: no-repeat; border:2px solid yellow; font-family: 'Courier'",
  ...
  "text": {
      "beganpester": "Ì‡˜‡Î ‰ÓÒÚ‡‚‡Ú¸",
      "ceasepester": "ÔÂÍ‡ÚËÎ ‰ÓÒÚ‡‚‡Ú¸",
      "blocked": "Á‡·ÎÓÍËÓ‚‡Î",
      "unblocked": "‡Á·ÎÓÍËÓ‚‡Î",
          "blockedmsg": "ÌÂ ÏÓÊÂÚ ÔÓÎÛ˜‡Ú¸ ÔËÒ¸Ï‡",
      "openmemo": "ÓÚÍ˚Î ÏÂÏÓ‡Ì‰ÛÏ Ì‡ ‰ÓÒÍÂ",
      "joinmemo": "ÓÚ‚ÂÚËÎ Ì‡ ÏÂÏÓ‡Ì‰ÛÏ",
      "closememo": "ÔÂÂÒÚ‡Î ÓÚ‚Â˜‡Ú¸ Ì‡ ÏÂÏÓ‡Ì‰ÛÏ",
      "kickedmemo": "¬˚ Á‡·‡ÌÂÌ˚ Ì‡ ˝ÚÓÈ ‰ÓÒÍÂ!",
          "idle": "ÚÂÔÂ¸ ·ÂÁ‰ÂÈÒÚ‚Û˛˘ËÈ ÍÓÂ¯!"
  },
 ...
 {"memoicon": "$path/memo.png",
  ...
  "label": { "text": "ƒÓÒÍ‡ Œ·˙ˇ‚ÎÂÌËÈ: $channel",
