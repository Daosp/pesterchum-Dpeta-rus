{"main":
 ...
 "menus": {"client": {"_name": "Альбом",
                       "options": "Ремикс",
                       "memos": "Группы",
                       "logviewer": "Истории",
                       "randen": "Случайная встреча",
                       "userlist": "Кореша",
                       "addgroup": "Новый экипаж",
                       "import": "Импорт",
                       "reconnect": "Пересоединение",
                       "idle": "Уснуть",
                       "exit": "Выйти"},
            "profile": {"_name": "Трэк",
                        "switch": "Сменить репера",
                        "theme": "Тема",
                        "color": "Цвет",
                        "block": "Хэйтеры",
                        "quirks": "Жаргон" },
            ...
            "rclickchumlist": {"pester": "Покровительствовать",
                               "removechum": "Forget",
                               "report": "Скажите СОРРА",
                               "blockchum": "Сломать",
                               "addchum": "Добавить в экипаж",
                               "viewlog": "Посмотреть логи",
                               "notes": "Изменить мнение...",
                               "unblockchum": "Устранить из списка",
                               "removegroup": "Забыть об экипаже",
                               "renamegroup": "Переименовать экипаж",
                               "movechum": "Переместить экипаж",
                               "banuser": "Баниш",
                               "opuser": "Задрать",
                               "voiceuser": "Читать реп",
                               "quirkkill": "Устранить правило",
                               "quirksoff": "Словарь OFF",
                               "invitechum": "Пригласить кореша",
                               "memosetting": "Настройки меморандума",
                               "memonoquirk": "Отключить правила",
                               "memohidden": "Заняться злыми битами",
                               "memoinvite": "Только по приглашению",
                               "memomute": "Отключиться" }
           },
