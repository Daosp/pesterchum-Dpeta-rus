{"inherits": "pesterchum2.5",
 ...
 {"background-image": "$path/lordthorn.png",
  ...
  "menus": {"client": {"_name": "Клиент",
                       "options": "Настройки",
                       "memos": "Культы",
                       "logviewer": "Гримуары",
                       "randen": "Случайный собеседник",
                       "userlist": "Новые последователи",
                       "import": "Импорт",
                       "talk": "Поговорить",
                       ...
                       "idle": "Спать",
                       "exit": "Выход",
					   "console": "За завесой мироздания..."},
            "profile": {"_name": "Профиль",
                        "switch": "Сменить",
                        "color": "Цвет",
                        "theme": "Стиль",
                        "block": "Демоны",
            ...
            "help": {"reportbug": "Сообщить о баге",
                     ...
                     "help": "Помощь",
                     "calsprite": "Келспрайт",
                     "chanserv": "Проверка связи",
                     "nickserv": "Древние имена"
              },
            "rclickchumlist": {"pester": "Вызвать",
                               "removechum": "Удалить последователя",
                               "blockchum": "Заблокировать",
                               "report": "Пожаловаться",
                               "addchum": "Добавить последователя",
                               "viewlog": "Прочитать том",
                               "ooc": "Вставлять скобки",
                               "unblockchum": "Разблокировать",
                               "banuser": "В бан",
                               "opuser": "Проверить",
                               "quirksoff": "Своё изречение"
                              }
           },
