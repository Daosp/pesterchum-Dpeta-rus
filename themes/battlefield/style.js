{"main":
 {"style": "background-repeat: no-repeat; font-family: 'Courier'; font-size: 14px;",
  ...
  "menus": {"client": {"_name": "Войны",
                       "options": "Правила",
                       "memos": "Сражения",
                       "talk": "Переговорить",
                       "logviewer": "Легенды",
                       "userlist": "Пешки",
                       "randen": "Случайная пешка",
                       "addgroup": "Новый отряд",
                       "import": "Укрепиться",
                       "reconnect": "Воксреситься",
                       "idle": "Отстать",
                       "console": "Консоль",
                       "exit": "Дезертировать"},
            "profile": {"_name": "Документ",
                        "switch": "Изменить документ",
                        "color": "Оттенок",
                        "theme": "Флаг",
                        "block": "Мишени",
                        "quirks": "Ввод"},
