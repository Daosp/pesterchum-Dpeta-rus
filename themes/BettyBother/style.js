{"main":
 {"style": "background-repeat: no-repeat;",
  ...
  "menus": {"client": {"_name": " À»≈Õ“",
            ...
            "profile": {"_name": "œ–Œ‘»À‹",
                        ...
                        "block": "“–ŒÀÀ—À”Ã",
                        "quirks": "œ–¿¬»À¿"},
            "help": {"reportbug": "—ÓÓ·˘ËÚ¸ Ó ·‡„Â", "_name": "œŒÃŒŸ‹",
                      "about": "Œ œ–Œ√–¿ÃÃ≈",
                      "help": "œŒÃŒŸ‹",
                      "calsprite": " ≈À—œ–¿…“",
                      "chanserv": "œ–Œ¬≈– ¿  ¿Õ¿À¿",
 ...
 {"style": "background-color: rgba(0,0,0,0);border-width: 5px; border-image:url($path/convobg.png) 5px; font-family: 'Arial'",
  ...
  "text": {
      "beganpester": "Ì‡˜‡Î ·ÂÒÔÓÍÓËÚ¸",
      "ceasepester": "Á‡ÍÓÌ˜ËÎ ·ÂÒÔÓÍÓËÚ¸",
      "blocked": "Á‡·ÎÓÍËÓ‚‡Î",
      "unblocked": "‡Á·ÎÓÍËÓ‚‡Î",
      "blockedmsg": "ÌÂ ÒÏÓ„ ÔÓÎÛ˜ËÚ¸ ·ÂÒÔÓÍÓÈÒÚ‚Ó ÓÚ",
      "openmemo": "ÓÚÍ˚Î ‰ÓÒÍÛ Ò Ô‡ÏˇÚÍ‡ÏË",
      "joinmemo": "ÓÚ‚ÂÚËÎ Ì‡ Á‡ÏÂÚÍÛ",
      "closememo": "ÔÂÂÒÚ‡Î ÓÚ‚Â˜‡Ú¸ Ì‡ Á‡ÏÂÚÍË",
      "kickedmemo": "¬‡Ò ‚˚„Ì‡ÎË ËÁ ˝ÚÓ„Ó ÏÂÒÚ‡!",
          "idle": "ÓÚÓ¯∏Î ÓÚ ÍÎ‡‚Ë‡ÚÛ˚!"
  },
